...
for(let i=0;i<nono;i++){//j'ai fait une boucle pour que ci les moniteur ou jason son mort on sore de la boucle.
    ...
    gta = (Math.floor(Math.random()  * 4) + 1);
    hio = (Math.floor(Math.random()  * 3) + 1);
    prt = (Math.floor(Math.random()  * 2) + 1);
    gto = (Math.floor(Math.random()  * 1) + 1);
    ...
    if(moniteur1==5){//la ces si les moniteut sont tous la.
        ...
        switch (prt) {
            ...
            switch (prt) {
                case 1:
                    console.log("le moniteur"+" "+ moniteur[prt]+" "+"est un>/e"+" "+caractéristique[0] +" "+"meure");
                    moniteur.splice(prt,1);
                    moniteur1-=1;
                   
            break;
                case 2:
                    console.log("le moniteur"+" "+ moniteur[prt]+" "+"est un"+" "+caractéristique[0]+" "+ "blese"+" "+ tuer+" "+"lui retire"+" "+10+" "+"pv");
                    pvJason-=10
            break;
                case 3:
                    console.log("le moniteur"+" "+ moniteur[prt]+" "+"est un/e"+" "+caractéristique[0]+" "+ "meure mais blese"+" "+ tuer+" "+15+" "+"pv");
                    pvJason-=15
                    moniteur.splice(prt,1);
                    moniteur1-=1;
